...
class ValidateExerciseController extends GetxController {
  ...
  void onInit() {
    super.onInit();
    getExercisesToValidate();
  }

  Future<void> getExercisesToValidate() async {
    try {
      ...
      originalResults = await ExerciseRepository.instance.getExercisesToValidate(credentials!.jwt);
