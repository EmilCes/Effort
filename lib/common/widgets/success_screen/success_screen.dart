  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Padding(
            padding: EffortSpacingStyle.paddingWithAppBarHeight * 2,
          child: Column(
            children: [
              // Image
              Image(image: AssetImage(image), width: EffortHelperFunctions.screenWidth() * 0.6,),
              ...
              SizedBox(
                  ...
                  child: ElevatedButton(onPressed: onPressed, child: const Text(EffortTexts.effortContinue))
              ),
            ],
          ),
        ),
